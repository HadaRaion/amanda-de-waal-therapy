...
export default function ServicesList() {
	return (
		<section className="flex flex-col md:flex-row border-y border-black">
            ...
            border-b border-black [&:nth-child(14)]:border-b-0 md:[&:nth-child(13)]:border-b-0">
						{service}
					</li>
				))}
				<span className="font-sm h-20 md:col-span-2 flex items-center px-5 sm:px-8 md:px-12 border-t border-black">
					* I have experience supporting individuals with challenges including
					but not limited to the list above.
				</span>
			</ul>
		</section>
	);
