...
export default function ServicesPage() {
	return (
		<>
			...
			<PageWrapper>
				<ServicesInfo />
				<Banner sentence1="There is no “one size fits all” when it comes to therapy, which means that I have the honour of catering treatment to meet my client's needs, in ways where they get to feel safe, seen and known. My services don’t come with the intention of “fixing” you, because I don’t believe that you need fixing. Instead, I fully believe that you are already whole, and it’s your innate biological pull towards healing that will guide our sessions. " />
				<ServicesList />
				<Banner
